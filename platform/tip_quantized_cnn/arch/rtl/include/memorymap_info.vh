...
`define I_GEMM_REQUANT_CONTROL_BASEADDR (32'h e2020000)
`define I_GEMM_REQUANT_CONTROL_SIZE (32'h 1000)
`define I_GEMM_REQUANT_CONTROL_LASTADDR (32'h e2020fff)
`define I_IM2COL_CONTROL_BASEADDR (32'h e2021000)
`define I_IM2COL_CONTROL_SIZE (32'h 1000)
`define I_IM2COL_CONTROL_LASTADDR (32'h e2021fff)
